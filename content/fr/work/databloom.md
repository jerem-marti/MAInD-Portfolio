---
title: "DataBloom"
summary: "Une interface tangible qui rend perceptible, à la maison, l'impact énergétique des usages numériques. La tige de la fleur se courbe à mesure qu'augmente la consommation hebdomadaire de données du foyer, et une lumière en son centre signale le débit de données en direct."
status: "live"
hero: "/images/work/databloom/hero.jpg"
heroAlt: "La fleur DataBloom achevée dans un petit pot en terre cuite — des pétales en feutre bleu cobalt, un centre en bois clair, une tige verte segmentée — sur un fond de studio blanc, entourée des pièces imprimées en 3D et de l'électronique qui la composent."
...
problem:
  - >-
    Environ 8% de l'électricité suisse alimente l'infrastructure numérique, et le numérique
    représente 3 à 4% des émissions mondiales de gaz à effet de serre, une part qui
    ...
    utilise le réseau, rien de tout cela ne prend corps.
  - >-
    ...
    c'est un total sans histoire, et les données détaillées, pour autant qu'un portail existe,
    restent hors de vue.
  - >-
    ...
    notifications, et ne touche que les personnes déjà assez concernées pour l'installer.
    Le cahier des charges s'est donc resserré. Donner à la consommation énergétique numérique d'un
...
role:
  led:
    ...
    - "Recherche de fond et positionnement autour des interfaces tangibles, de la physicalisation de données et de la Calm Technology"
    ...
    - "Deux séries de tests utilisateurs : un test comparatif basse fidélité, puis une évaluation du prototype fonctionnel"
  contributed:
    - "Décisions méthodologiques prises avec le mandant et les superviseurs, comme le choix du premier concept par test comparatif plutôt que d'autorité"
  ...
  - label: "Première itération"
    ...
    prose:
      - >-
        ...
        pas l'ingénierie.
      - >-
        Le prototype de la fleur avait une double fonction. Il testait si les gens comprenaient le
        flétrissement comme un avertissement, et si le mouvement était même réalisable : un
    ...
    artifacts:
      - src: "/images/work/databloom/approach-3-lowfi.jpg"
        ...
        decision: "La métaphore de la fleur se lisait instantanément ; le personnage devait être décodé. Le test comparatif a fondé le choix sur des preuves, et non sur un goût personnel."
        width: "wide"
  ...
  - label: "Prototype fonctionnel"
    ...
    prose:
      - >-
        ...
        profond, avec un serveur local qui héberge la logique de consommation et l'appareil qui
        ...
        chaleureux et moins technique. Le pot est en terre cuite ordinaire, pour que l'objet tout
        entier se lise comme quelque chose qui a déjà sa place sur une étagère.
      - >-
        Deux signaux portent l'information. La posture de la tige montre la consommation numérique
        cumulée du foyer sur la semaine, rapportée à un seuil personnel, fixé à l'installation et
        destiné à se resserrer avec le temps, pour faire doucement baisser la consommation. La
      ...
      - >-
        Faire passer le câblage à travers une tige qui doit se courber a été le plus long combat
        discret de la construction. La première tige était une pièce imprimée d'un seul tenant et
    ...
    artifacts:
      - src: "/images/work/databloom/approach-4-stem.jpg"
        ...
        decision: "L'assemblage segmenté a coûté plus de pièces et plus de temps de construction, en échange du passage des câbles et de la réparation sur place. Pour un objet destiné à vivre dans un foyer, la durabilité l'a emporté."
        width: "half"
      - src: "/images/work/databloom/approach-5-flowerhead.jpg"
        ...
        decision: "Diffuser la lumière à travers le feutre plutôt que de l'exposer a gardé l'objet calme. Une courbe de gradation a été ajoutée une fois la lumière jugée trop vive la nuit."
        width: "half"
      - src: "/images/work/databloom/approach-circuit.jpg"
        ...
        decision: "Dessiner un schéma complet avant de souder a fiabilisé la construction sur veroboard, et a rendu l'électronique reproductible plutôt qu'un enchevêtrement de fils irreproductible."
        width: "wide"
      - src: "/images/work/databloom/approach-assembly.jpg"
        ...
        decision: "Documenter la construction comme un guide éclaté, étape par étape, permettait de réimprimer n'importe quelle pièce et de réassembler la fleur entière à la main."
        width: "wide"
  ...
  - label: "Évaluation"
    ...
    prose:
      - >-
        ...
        situations de vie délibérément variées (une colocation, une personne seule, un couple, une
      ...
      - >-
        ...
        fleur réagir en direct. Tout le monde a lu la tige correctement, sans qu'aucune
      ...
      - >-
        ...
        tige au lieu de montrer le débit en direct. On n'a pas vraiment pu observer son vrai rôle,
      ...
      - >-
        ...
        choix de streaming intensif, les participants modifiaient leur action suivante en pleine
        tâche. L'un s'est arrêté et a dit "ça m'a un peu freiné quand j'ai vu la
...
outcome:
  - >-
    Un prototype fonctionnel qui tourne : mécanique, électronique et firmware stables, réagissant en
    temps réel à des données de foyer simulées.
  - >-
    Une reconnaissance immédiate. Chaque participant a lu le flétrissement sans aide, et tous ont dit
    qu'ils placeraient la fleur dans leur propre foyer, le plus souvent à un endroit de passage comme
    une console d'entrée ou un plan de travail de cuisine.
  - >-
...
reflection: >-
  Le calendrier était la vraie contrainte. Avec une construction comprimée en onze semaines, je n'ai
  jamais pu mener la seconde itération vers laquelle pointaient les tests : une courbe de
  flétrissement plus douce, une lumière plus lisible, et un moyen pour la fleur de se rétablir quand
  un foyer fait mieux. Une fleur qui ne fait jamais que s'affaisser finit par ne plus motiver. La
