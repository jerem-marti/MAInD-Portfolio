...
brief:
  role: "Recherche et stratégie"
  year: "2024 — 2025"
  host: "HEIG-VD · Startup + Crunch"
  scope: "Projet d'équipe"
  shipped: "Business plan, finances, pitch"

problem:
  - >-
    Les organisations qui reposent sur le bénévolat (associations, ONG, institutions culturelles,
    festivals) se heurtent toutes au même mur : recruter des personnes fiables est lent et incertain, et
    les désistements de dernière minute sont fréquents. De l'autre côté, les bénévoles trouvent des
    opportunités par le bouche-à-oreille, ont peu de visibilité sur ce qui leur correspond, et n'obtiennent
    aucune reconnaissance concrète pour leur présence.
  - >-
...
approach:
  ...
  - label: "Concept"
    ...
    artifacts:
      - alt: "Un tableau de fonctionnalités MoSCoW pour À ta Dispo : les Must-have incluent l'annonce, la mise en relation, la gamification et les badges ; les Could-have et Won't-have repoussent la planification d'événements et le classement des bénévoles hors du périmètre."
        caption: "Les fonctionnalités, triées par MoSCoW."
        decision: "La mise en relation et la reconnaissance figurent en Must-have ; la planification et les outils de gestion sont rangés en Won't-have, pour que le périmètre reste honnête."
        width: "wide"
        src: "/images/work/a-ta-dispo/artifact-concept.jpg"

  - label: "Business case"
    title: "De l'idée à un modèle défendable"
    prose:
      - >-
...
outcome:
  ...
  - >-
    ...
    la recherche de marché, la modélisation d'affaires et la finance.
...
gallery:
  - alt: "La diapositive du problème : à gauche, deux citations d'un bénévole et d'un organisateur, et à droite le besoin validé, avec des chiffres de sondage de 60 % et de plus de 50 % appuyant chaque côté."
    caption: "Le problème, validé."
    src: "/images/work/a-ta-dispo/gallery-01-problem.jpg"
  - alt: "Une analyse des cinq forces de Porter pour À ta Dispo, évaluant le pouvoir des fournisseurs comme faible, celui des acheteurs comme élevé, la rivalité et les nouveaux entrants comme modérés, et les substituts comme élevés."
    caption: "Les cinq forces de Porter."
    src: "/images/work/a-ta-dispo/gallery-02-porter.jpg"
  - alt: "Un entonnoir de marché total, adressable et atteignable construit à partir des données suisses sur les événements culturels, ramenant environ 9'315 événements à quelque 3'450 qui ont réellement besoin de bénévoles externes."
    caption: "Dimensionner le marché."
    src: "/images/work/a-ta-dispo/gallery-03-market.jpg"
  - alt: "Deux canevas de proposition de valeur pour À ta Dispo, cartographiant les tâches, frustrations et bénéfices des bénévoles et des organisateurs face aux fonctionnalités de la plateforme."
    caption: "La proposition de valeur."
    src: "/images/work/a-ta-dispo/gallery-04-value.jpg"
  - alt: "Une carte concurrentielle situant À ta Dispo face à EHRO, Swiss Volunteers et benevol sur deux axes : la qualité de la mise en relation et l'étendue de la base de bénévoles."
    caption: "Sa position face aux rivaux."
    src: "/images/work/a-ta-dispo/gallery-05-competition.jpg"
  - alt: "Le modèle tarifaire : un pack Basique, Évolutif et Premium facturé par événement, avec des suppléments optionnels pour la visibilité et le suivi."
    caption: "Le modèle tarifaire."
...
card:
  title: "À ta Dispo — mettre en relation les bénévoles d'événements avec les organisateurs"
  alt: "Le logotype dessiné à la main d'À ta Dispo, un logo corail sur une forme d'autocollant rose, sur un fond corail uni."
