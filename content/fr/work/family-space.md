...
summary: "Un projet commandé par UBS pour simplifier son application mobile autour de l'éducation financière. La réponse de l'équipe a été un espace familial partagé pour les parents et les enfants. Ma part a été la recherche utilisateur collaborative et les user flows détaillés qui ont cartographié son fonctionnement réel."
status: "live"
heroAlt: "Deux écrans de téléphone sur un dégradé rouge doux à côté de la phrase « A shared space for a parent and a child » : un hub parent montrant les analyses, les limites et les objectifs de l'enfant, et l'écran d'objectif d'épargne de l'enfant avec sa progression vers un vélo."
hero: "/images/work/family-space/hero.jpg"

brief:
  role: "Recherche et user flows"
  year: "2025"
  host: "SUPSI × UBS"
  scope: "Équipe de cinq"
  shipped: "Recherche, user flows, prototype Figma"
...
problem:
  ...
  - >-
    ...
    d'une fonctionnalité enfouie en une raison de rester ?
...
role:
  ...
  team: "Équipe de cinq (Andrii Ioffe, Edoardo Carlani, Giorgia Salmoiraghi, Jérémy Martin, Oleksandra Drapushko) pour ID111 Designing Digital Experiences à la SUPSI, avec une phase de recherche menée de façon collaborative. Commandé par UBS."

approach:
  - label: "Recherche"
    title: "Écouter avant de concevoir"
    prose:
      - >-
        La recherche a été un effort véritablement collaboratif, et la partie que j'ai le plus
        appréciée. En équipe, nous avons combiné une recherche documentaire sur l'éducation
        financière, la littératie financière, la banque au quotidien et le paysage concurrentiel ; un
    ...
    artifacts:
      - src: "/images/work/family-space/artifact-research-quote.jpg"
        ...
        caption: "Recherche — un parent, en entretien."
        decision: "Les entretiens ramenaient sans cesse à enseigner la valeur de l'argent, et non à ajouter un produit de plus."
        width: "wide"

  - label: "Direction"
    title: "Faire du « nice to have » le sujet"
    prose:
      - >-
  ...
  - label: "Définition"
    title: "De la recherche à un problème qui vaut la peine d'être résolu"
    prose:
      - >-
        ...
        plus grand.
      - >-
        La tension entre eux a produit un ensemble de questions How Might We (transformer la banque du
        quotidien en moments d'apprentissage, rendre la valeur de l'argent visible, soutenir une
        éducation adaptée à l'âge) et deux énoncés de problème nets. Sophie a besoin d'un moyen simple
        d'enseigner la banque au quotidien tout en gardant des limites sûres, parce qu'elle ne se sent
        pas équipée pour les guider ; Leo a besoin d'un moyen clair et visuel de voir ce qu'il peut
        dépenser et épargner, parce qu'il ne voit l'argent que comme quelque chose pour s'amuser.
    artifacts:
      - src: "/images/work/family-space/artifact-define-affinity.jpg"
        alt: "Un diagramme d'affinités de six thèmes de recherche regroupés : éviter la conversation, contrôle contre confiance, la valeur de l'argent, commencer jeune selon l'âge, dépensier contre épargnant, et les leçons que les parents transmettent."
        caption: "Définition — le diagramme d'affinités."
        decision: "Le regroupement a fait émerger la vraie tension : les parents veulent aider sans surveiller."
        width: "wide"
  ...
  - label: "Idéation"
    ...
    prose:
      ...
      - >-
        ...
        (limites sûres, niveaux selon l'âge, cercles de personnes de confiance), la banque au quotidien
        comme des « money missions » où des actions réelles deviennent de petits moments
    ...
    artifacts:
      - src: "/images/work/family-space/artifact-ideate-pillars.jpg"
        alt: "La grande idée présentée en trois piliers : pratiquer avec des garde-fous, la banque au quotidien comme des money missions, et un Family Space conçu pour la conversation plutôt que pour la surveillance."
        caption: "Idéation — la grande idée, en trois piliers."
        decision: "Le cadrer comme du coaching plutôt que du contrôle a donné le ton à tout le concept."
        width: "wide"

  - label: "Flows"
    title: "Quatre flows, de bout en bout"
    prose:
      - >-
      ...
      - >-
        ...
        plutôt qu'abstraite. L'adolescent a son propre flow parce que sa relation à l'argent, à
        l'autonomie et à la vie privée est véritablement différente, et les flows sont la partie de ce
        projet que j'ai portée de bout en bout.
    artifacts:
      - src: "/images/work/family-space/artifact-flows-activation.jpg"
        alt: "Un flow d'activation en trois étapes montré sur des écrans de téléphone : ouvrir la nouvelle section Family, sélectionner l'enfant, puis suivre les analyses, les limites et les objectifs de l'enfant."
        caption: "Flows — activer le Family Space."
        decision: "Des limites recommandées préremplies font qu'un parent ne configure jamais à partir d'une page blanche."
        width: "wide"
...
outcome:
  ...
  - >-
    ...
    mensuel), transformant la grande idée en quelque chose de navigable écran par écran.
  - >-
    Un prototype Figma du Family Space partagé, présenté directement à l'équipe UBS, qui a transformé
    un projet de cours en une véritable conversation client.

reflection: >-
  Ce que je retire de ce projet, c'est la partie du travail qu'il est facile de sauter et difficile
...
gallery:
  ...
  - src: "/images/work/family-space/gallery-analytics.jpg"
    ...
    caption: "Enfant — analyses personnelles des dépenses."
  - src: "/images/work/family-space/gallery-goal.jpg"
    alt: "L'écran d'objectif d'épargne d'un enfant pour un vélo montrant CHF 366 épargnés sur CHF 3'000, une barre de progression à 13 pour cent, et une illustration de tirelire."
    caption: "Enfant — épargner pour un objectif."
  - src: "/images/work/family-space/gallery-kebab.jpg"
    alt: "Un énoncé indiquant que CHF 20 correspond à environ deux kebabs, montrant comment l'application traduit une dépense en un équivalent du quotidien qu'un adolescent comprend."
    caption: "Flows — rendre la valeur de l'argent tangible."
...
card:
  title: "UBS Family Space — l'endroit partagé d'une famille pour gérer l'argent"
  image: "/images/work/family-space/adjacent.jpg"
  alt: "Concept UBS Family Space : deux écrans de téléphone sur un dégradé rouge doux, un hub parent pour les analyses, les limites et les objectifs de l'enfant, et l'écran d'objectif d'épargne de l'enfant."
---
